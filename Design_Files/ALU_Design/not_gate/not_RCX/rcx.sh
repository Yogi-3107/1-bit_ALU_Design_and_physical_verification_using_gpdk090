#!/bin/ksh
# This script was generated Tue Jan 14 00:21:34 2025 by:
#
...
#	/home/buet/project_work/ALU_Design/not_gate/not_LVS.xcn \
#	-assura_run_dir /home/buet/project_work/ALU_Design/not_gate \
#	-assura_run_name not_LVS -rcxdir \
#	/home/buet/project_work/ALU_Design/not_gate/not_RCX -xy_coordinates \
#	c,r -type full -temperature 25.0 -sub_node_char # -res_models no \
#	-rcxfs_type none -parasitic_res_models comment -parasitic_cap_models \
#	no -output_net_name_space layout -output \
#	/home/buet/project_work/ALU_Design/not_gate/not_RCX/extview.tmp \
...
#	-array_vias_spacing auto -extract both
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
...
##NETS_FILE=/dev/null
##OUTPUT=/home/buet/project_work/ALU_Design/not_gate/not_RCX/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/buet/project_work/ALU_Design/not_gate/not_RCX
##RCXFS_HIGH=N
...
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
cd /home/buet/project_work/ALU_Design/not_gate/not_RCX
...
vdbToRcx /home/buet/project_work/ALU_Design/not_gate not_LVS -unit meters -- \
	-V1 -H satfile -r \
	/home/buet/project_work/ALU_Design/not_gate/not_LVS.xcn -df2 -xgl
